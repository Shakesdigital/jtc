      ...
      <section id="programs" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-church-gray leading-relaxed">
                Our discipleship programs equip the church family to go and make disciples, bringing people to Christ and nurturing them in their faith. Through <strong className="text-church-sage-dark">Bible Study Classes</strong>, we help you master Scripture and grow in biblical knowledge. <strong className="text-church-sage-dark">Leadership Training</strong> develops servant leaders who can effectively guide others in their spiritual journey. <strong className="text-church-sage-dark">Mentorship Groups</strong> connect mature believers with those seeking guidance, creating a culture of spiritual multiplication. <strong className="text-church-sage-dark">Prayer Workshops</strong> deepen your communion with God, equipping you to intercede for the lost and teach others to pray. <strong className="text-church-sage-dark">Ministry Skills Training</strong> provides practical tools for evangelism, teaching, and shepherding new believers. Through <strong className="text-church-sage-dark">Life Purpose Discovery</strong>, we help you identify your God-given gifts and calling to reach others with the Gospel and build His kingdom.
              </p>
            </motion.div>
          </div>
        </div>
