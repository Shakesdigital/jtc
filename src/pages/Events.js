    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=1920&h=1080&fit=crop')`
          }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 sm:px-6 py-16">
          <motion.div
            ...
            className="space-y-6"
          >
            <FiCalendar className="w-20 h-20 mx-auto mb-3 sm:mb-4 text-church-yellow" />
