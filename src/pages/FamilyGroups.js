    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(110, 152, 150, 0.8), rgba(90, 125, 123, 0.8)), url('https://images.unsplash.com/photo-1511895426328-dc8714191300?w=1920&h=1080&fit=crop')`
          }}
        />
