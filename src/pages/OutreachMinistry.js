    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(110, 152, 150, 0.85), rgba(90, 125, 123, 0.85)), url('https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=1920&h=1080&fit=crop')`
          }}
        />
