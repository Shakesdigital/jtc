    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(110, 152, 150, 0.85), rgba(90, 125, 123, 0.85)), url('https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1920&h=1080&fit=crop')`
          }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-6 py-20">
          <motion.div
            ...
            className="space-y-8"
          >
            <FiVideo className="w-20 h-20 mx-auto mb-8 text-church-yellow" />
